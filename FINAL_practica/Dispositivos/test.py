...
from database import Database,Dispositivo
...
class MyTest(unittest.TestCase):
    ...
    def test_create_database(self):
        ...
        self.assertTrue(self.compare_dispositivos(self.dispositivo_1, database.database[0]))
        self.assertTrue(self.compare_dispositivos(self.dispositivo_2, database.database[1]))
        self.assertTrue(self.compare_dispositivos(self.dispositivo_3, database.database[2]))
    ...
    def test_delete_by_id(self):
        ...
        self.assertTrue(self.compare_dispositivos(self.dispositivo_1, database.database[0]))
        self.assertTrue(self.compare_dispositivos(self.dispositivo_3, database.database[1]))
    ...
    def test_add_dispositivo(self):
        ...
        self.assertTrue(self.compare_dispositivos(self.dispositivo_2, database.database[1]))
        self.assertTrue(self.compare_dispositivos(self.dispositivo_3, database.database[2]))
        self.assertTrue(self.compare_dispositivos(self.dispositivo_4, database.database[3]))
